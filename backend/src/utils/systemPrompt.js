...
Use exactly this shape:
{
  "files": [
    ...
    {"filename": "script.js", "content": "full JavaScript here"}
  ]
}

Always include exactly these three files, in this order. Do not add files or properties.
In index.html, link style.css and script.js. Keep the website responsive, accessible, and concise.
`;
